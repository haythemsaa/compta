  ...
  <div class="expense-report-detail">
    <div class="header">
      <div>
        ...
        <p v-if="!isNew" class="reference">{{ report?.reference }}</p>
      </div>
      <div class="actions">
        ...
        <div v-else class="items-list">
          ...
          >
            ...
            <div class="item-details">
              ...
              <p class="item-description">{{ mileage.purpose }}</p>
            </div>
            <div class="item-footer">
    ...
    <!-- Modals would go here for adding items/mileage -->
  </div>
</template>
...
const addExpenseItem = () => {
  // TODO: Open modal to add expense item
  alert('Modal pour ajouter une dépense à implémenter')
}

const addMileageExpense = () => {
  // TODO: Open modal to add mileage expense
  alert('Modal pour ajouter un frais kilométrique à implémenter')
}
